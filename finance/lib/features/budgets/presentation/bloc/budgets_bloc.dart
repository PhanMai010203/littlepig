...
class BudgetsBloc extends Bloc<BudgetsEvent, BudgetsState> {
  ...
  Future<void> _onUpdateBudget(UpdateBudget event, Emitter<BudgetsState> emit) async {
    try {
  ...
  Future<void> _onDeleteBudget(DeleteBudget event, Emitter<BudgetsState> emit) async {
    try {
