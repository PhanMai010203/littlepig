            ...
            if (state is TransactionsPaginated) {
              return SliverMainAxisGroup(
                slivers: [
                  ...
                  SliverToBoxAdapter(
                    child: _PaginatedSummaryWrapper(
                      pagingState: state.pagingState,
                      selectedMonth: state.selectedMonth,
                    ),
                  ),
                  _PaginatedTransactionListWrapper(
                    pagingState: state.pagingState,
...
class _PaginatedSummaryWrapper extends StatelessWidget {
  const _PaginatedSummaryWrapper({
...
class _PaginatedTransactionListWrapper extends StatelessWidget {
  const _PaginatedTransactionListWrapper({
    required this.pagingState,
    required this.categories,
    required this.selectedMonth,
  });
      ...
      child: Padding(
        ...
        child: Column(
          children: [
            ...
            const SizedBox(height: 16),
            ElevatedButton(
              onPressed: () => context.read<TransactionsBloc>().add(FetchNextTransactionPage()),
              child: const AppText('Retry'),
            ),
          ],
        ),
