...
class _$ChatMessageImpl implements _ChatMessage {
  ...
  @override
  String toString() {
    return 'ChatMessage(id: $id, text: $text, isFromUser: $isFromUser, timestamp: $timestamp, isTyping: $isTyping, isVoiceMessage: $isVoiceMessage)';
  }
  ...
  int get hashCode => Object.hash(
      runtimeType, id, text, isFromUser, timestamp, isTyping, isVoiceMessage);
...
abstract class _ChatMessage implements ChatMessage {
  const factory _ChatMessage(
      ...
      final bool isTyping,
      final bool isVoiceMessage}) = _$ChatMessageImpl;
