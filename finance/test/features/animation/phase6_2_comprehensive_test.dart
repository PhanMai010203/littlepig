  ...
  group('Phase 6.2 Comprehensive Tests - Animation Performance Monitoring & Integration', () {
    ...
    group('AnimationPerformanceMonitor Widget Tests', () {
      ...
      testWidgets('monitor updates performance data in real-time', (tester) async {
        ...
        expect(find.text('Animations: 0 / 4'), findsOneWidget); // Detailed view text
    ...
    group('Real-time Performance Tracking Integration', () {
      testWidgets('AnimationUtils tracks animation metrics correctly', (tester) async {
        ...
        final animationMetrics = Map<String, dynamic>.from(metrics['animationMetrics'] as Map);
    ...
    group('Performance Optimization and Scaling', () {
      ...
      test('staggered animation logic respects capacity', () async {
        ...
        // Start with 0 animations - should allow staggered
        expect(AnimationPerformanceService.shouldUseStaggeredAnimations, isTrue);
        
        // Fill up to threshold (maxSimultaneousAnimations / 2 = 2)
        AnimationPerformanceService.registerAnimationStart();
        AnimationPerformanceService.registerAnimationStart();
        
        // Should now disable staggered animations (at threshold)
