...
void main() {
  group('AnimationPerformanceService - Phase 6.1 Tests', () {
    ...
    group('getOptimizedDuration', () {
      ...
      test('returns enhanced duration when animationLevel is enhanced',
          () async {
        await AppSettings.set('animationLevel', 'enhanced');
        final result =
            AnimationPerformanceService.getOptimizedDuration(baseDuration);
    ...
    group('getOptimizedCurve', () {
      test('returns simple curve for reduced animations', () async {
        await AppSettings.set('animationLevel', 'reduced');
        final result =
            AnimationPerformanceService.getOptimizedCurve(Curves.bounceIn);
      ...
      test('returns enhanced curve for enhanced animations', () async {
        await AppSettings.set('animationLevel', 'enhanced');
        final result =
            AnimationPerformanceService.getOptimizedCurve(Curves.linear);
      ...
      test('returns default curve for normal animations', () async {
        ...
        final result =
            AnimationPerformanceService.getOptimizedCurve(defaultCurve);
    ...
    group('getPerformanceProfile', () {
      ...
      test('reflects current settings correctly', () async {
        ...
        expect(profile['shouldUseComplexAnimations'],
            isFalse); // Because batterySaver is true
        expect(profile['maxSimultaneousAnimations'],
            equals(1)); // Because batterySaver is true
      });
    });
